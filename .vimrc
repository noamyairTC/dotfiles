...
autocmd filetype python nnoremap <silent> <leader>u yyp_w<C-v>$r-
autocmd filetype python nnoremap <silent> <leader>U yyp_w<C-v>$r=

"" Shortcut to remove all trailing white spaces
nnoremap <leader>t :let _s=@/ <Bar> :%s/\s\+$//e <Bar> :let @/=_s <Bar> :nohl <Bar><cr>
vnoremap <leader>t :let _s=@/ <Bar> :%s/\s\+$//e <Bar> :let @/=_s <Bar> :nohl <Bar><cr>
...
if IsPlugin("ale")
    let g:ale_python_flake8_args="--ignore=E501,E123,E124,E266"
endif
